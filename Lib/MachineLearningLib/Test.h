...
extern "C" MACHINELEARNINGLIB_API void** createModelPMC(int* _npl, int _sizeNpl);

void propagatePMC(float* inputs, bool isClassification, int* d, int* sizeNpl, int* maxN, float* X, float* W);

extern "C" MACHINELEARNINGLIB_API float* predictPMC(float* inputs, bool isClassification, void** model);

extern "C" MACHINELEARNINGLIB_API void trainPMC(int sizeT, float* xTrain, int sizeDataXTrain, float* yTrain, int sizeDataYTrain, bool isClassification, float alpha, int nbIter, void** model);
